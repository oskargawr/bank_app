...
class TestCreateBankAccount(unittest.TestCase):
    ...
    def test_tworzenie_konta(self):
        pierwsze_KontoOsobiste = KontoOsobiste(
            self.imie, self.nazwisko, self.pesel)
        self.assertEqual(pierwsze_KontoOsobiste.imie, self.imie,
                         "Imie nie zostało zapisane!")
        self.assertEqual(pierwsze_KontoOsobiste.nazwisko, self.nazwisko,
                         "Nazwisko nie zostało zapisane!")
        self.assertEqual(pierwsze_KontoOsobiste.saldo,
                         0, "Saldo nie jest zerowe!")
        self.assertEqual(pierwsze_KontoOsobiste.pesel, self.pesel,
